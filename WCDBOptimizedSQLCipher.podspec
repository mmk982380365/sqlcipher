...
Pod::Spec.new do |sqlcipher|
  ...
  sqlcipher.source       = { :git => "https://github.com/Tencent/sqlcipher.git", :commit => "383adbb9e3706c2730e2e18a2e5edd08c5fbdfbc" }
  ...
  sqlcipher.module_map = "macosx/sqlcipher.modulemap"
end
